...
export async function POST(req: NextRequest, res: any) {
  try {
    ...
    const { name, company, email, phone, hear, interest } = body;
    ...
    const mail = await transporter.sendMail({
      ...
      <br></br>
      <div style="font-size: 18px; font-weight: bold; margin-bottom: 10px;">THANK YOU FOR BEING A SPONSOR</div>
      `,
    });
    ...
    const mailAdmin = await transporter.sendMail({
      ...
      <div style="font-size: 24px; font-weight: bold; margin-bottom: 10px;">Hello and good day!</div>
      <br></br>
      <div style="font-size: 18px; font-weight: bold; margin-bottom: 10px;">SPONSOR INFORMATION:</div>
      ...
      <div style="margin-bottom: 5px;">What are you most interested in? ${interest}</div>
